...
spin2_s_x = fn.kron_rmat_eye(spin1_x)
spin2_s_y = fn.kron_rmat_eye(spin1_y)
spin2_s_z = fn.kron_rmat_eye(spin1_z)
spin2_s_p = np.real(spin2_s_x + 1j * spin2_s_y)
spin2_s_m = np.real(spin2_s_x - 1j * spin2_s_y)

# 4x4 Matrices for I operator
spin2_i_x = fn.kron_eye_rmat(spin1_x)
spin2_i_y = fn.kron_eye_rmat(spin1_y)
spin2_i_z = fn.kron_eye_rmat(spin1_z)
