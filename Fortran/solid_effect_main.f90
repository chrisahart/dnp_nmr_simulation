program solid_effect_main
    ...
    !real(wp) :: microwave_amplitude(6) = [0.85, 0.85, 0.85, 0.85, 0.85, 0.85] * 1E6                             ! Microwave amplitude
    ...
    open(10, file = 'out/microwave_amplitude.out', status = 'replace')
    open(11, file = 'out/num_periods.out', status = 'replace')
    open(12, file = 'out/pol_iz_final.out', status = 'replace')
    ...
    write(3, *) pol_i_z_rot
    write(4, *) pol_s_z_rot
    write(10, *) microwave_amplitude
    write(11, *) num_periods
    write(12, *) pol_iz_final
    write(5, *) energies(:, 1)
    write(7, *) energies(:, 2)
    write(8, *) energies(:, 3)
    write(9, *) energies(:, 4)
